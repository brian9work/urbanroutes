...
export const WalkIcon = () => {
    return (
            <FontAwesome5 name="walking"
                size={20}
                className=" bg-common-blue/15 p-2 rounded-full"
                color="#007BFF"
            />
    )
}
...
export const MoneyIcon = () => {
    return (
        <View className=" bg-common-green/15 p-2 rounded-full">
...
export const ClockIcon = () => {
    return (
        <View className=" bg-common-blue/15 p-2 rounded-full">
...
export const RouteIcon = () => {
    return (
        <View className=" bg-yellow-200/30 p-2 rounded-full">
